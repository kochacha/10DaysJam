...
void KochaEngine::Application::Load()
{
	...
	Dx12_Texture::LoadTexture(device, "Resources/dokuroUI.png");
	...
	Dx12_Texture::LoadTexture(device, "Resources/backStar1.png");
	Dx12_Texture::LoadTexture(device, "Resources/backStar2.png");
	Dx12_Texture::LoadTexture(device, "Resources/moon_0.png");
	Dx12_Texture::LoadTexture(device, "Resources/moon_1.png");
	Dx12_Texture::LoadTexture(device, "Resources/moon_2.png");
	Dx12_Texture::LoadTexture(device, "Resources/moon_3.png");
	Dx12_Texture::LoadTexture(device, "Resources/rocket_0.png");
	Dx12_Texture::LoadTexture(device, "Resources/rocket_1.png");
	Dx12_Texture::LoadTexture(device, "Resources/rocket_2.png");
	Dx12_Texture::LoadTexture(device, "Resources/rocket_3.png");
	Dx12_Texture::LoadTexture(device, "Resources/flag_0.png");
	Dx12_Texture::LoadTexture(device, "Resources/flag_1.png");
	Dx12_Texture::LoadTexture(device, "Resources/flag_2.png");
	Dx12_Texture::LoadTexture(device, "Resources/flag_3.png");
	Dx12_Texture::LoadTexture(device, "Resources/peropero_0.png");
	...
	Dx12_Texture::LoadTexture(device, "Resources/yosokuUI.png");
